...
#
LineProgramEntry = namedtuple("LineProgramEntry", "command is_extended args state")
        ...
        while offset < self.program_end_offset:
            ...
            if opcode >= self.header["opcode_base"]:
                ...
                if opcode == DW_LNS_copy:
                    ...
                    address_addend = (adjusted_opcode // self["line_range"]) * self[
                    ...
                    dwarf_assert(
                        False, "Invalid standard line program opcode: %s" % (opcode,)
                    )
