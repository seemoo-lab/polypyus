...
def _init_dispatch_table(structs):
    ...
    def parse_arg_struct2(arg1_struct, arg2_struct):
        return lambda stream: [
            struct_parse(arg1_struct, stream),
    ...
    def parse_blob():
        return lambda stream: [
            read_blob(stream, struct_parse(structs.Dwarf_uleb128(""), stream))
        ]

    # ULEB128 with datatype DIE offset, then byte, then a blob of that size
    def parse_typedblob():
        return lambda stream: [
            struct_parse(structs.Dwarf_uleb128(""), stream),
            read_blob(stream, struct_parse(structs.Dwarf_uint8(""), stream)),
        ]
    ...
    add(
        "DW_OP_bregx",
        parse_arg_struct2(structs.Dwarf_uleb128(""), structs.Dwarf_sleb128("")),
    )
    add("DW_OP_piece", parse_arg_struct(structs.Dwarf_uleb128("")))
    add(
        "DW_OP_bit_piece",
        parse_arg_struct2(structs.Dwarf_uleb128(""), structs.Dwarf_uleb128("")),
    )
    ...
    add(
        ...
        parse_arg_struct2(structs.Dwarf_uint8(""), structs.Dwarf_uleb128("")),
    )
    add(
        "DW_OP_GNU_implicit_pointer",
        parse_arg_struct2(structs.Dwarf_offset(""), structs.Dwarf_sleb128("")),
    )
