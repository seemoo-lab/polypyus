...
class ELFStructs(object):
    ...
    def _create_rel(self):
        ...
        if self.elfclass == 32:
            fields = [
                ...
                Value("r_info_sym", lambda ctx: (ctx["r_info"] >> 8) & 0xFFFFFF),
                Value("r_info_type", lambda ctx: ctx["r_info"] & 0xFF),
            ]
            ...
            fields = [
                self.Elf_xword("r_info"),
                Value("r_info_sym", lambda ctx: (ctx["r_info"] >> 32) & 0xFFFFFFFF),
                Value("r_info_type", lambda ctx: ctx["r_info"] & 0xFFFFFFFF),
            ]
        ...
        self.Elf_Rela = Struct(
            "Elf_Rela", self.Elf_addr("r_offset"), *fields_and_addend
        )
    ...
    def _create_note(self, e_type=None):
        ...
        self.Elf_Nhdr = Struct(
            ...
            Enum(
                ...
                **(ENUM_NOTE_N_TYPE if e_type != "ET_CORE" else ENUM_CORE_NOTE_N_TYPE)
            ),
        )
        ...
        self.Elf_Nt_File = Struct(
            ...
            Array(
                lambda ctx: ctx.num_map_entries,
                Struct(
                    "Elf_Nt_File_Entry",
            ...
            Array(lambda ctx: ctx.num_map_entries, CString("filename")),
        )
    ...
    def _create_arm_attributes(self):
        ...
        self.Elf_Attr_Subsection_Header = Struct(
            ...
            self.Elf_ntbs("vendor_name", encoding="utf-8"),
        )

        # Structure of a build attribute tag.
        self.Elf_Attribute_Tag = Struct(
            "Elf_Attribute_Tag", Enum(self.Elf_uleb128("tag"), **ENUM_ATTR_TAG_ARM)
        )
