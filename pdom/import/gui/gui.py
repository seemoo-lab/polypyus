...
class GuiFromWindow(ida_kernwin.PluginForm):
    ...
    def create_gui(self):
        ...
        self.headline_elf = QtWidgets.QLabel(
            "Select ELF, Polypyus CSV, or import user-defined file."
        )
        self.selectFile_btn_elf = QtWidgets.QPushButton("Select file")
        self.import_btn_elf = QtWidgets.QPushButton("Import ELF")
        self.skip_btn_elf = QtWidgets.QPushButton("Skip")
        self.userdefined_csv_btn_elf = QtWidgets.QPushButton(
            "Import user-defined CSV file"
        )
        ...
        self.adjust_for_arm_thumb_checkbox = QtWidgets.QCheckBox(
            "Adjust for ARM Thumb mode (even vs. odd function starts)."
        )
        self.pathline_Elf = QtWidgets.QLineEdit()

        # import signatures
        self.headline_database = QtWidgets.QLabel(
            "Select database for import.\n All function types and global types will be overwritten!"
        )
        self.label_refDB = QtWidgets.QLabel("Reference database")
        ...
        self.getMultiplefiles_Database_to_List = QtWidgets.QPushButton(
            "Select database"
        )
        self.import_btn_database = QtWidgets.QPushButton("Import PDOM database")
        self.skip_btn_database = QtWidgets.QPushButton("Skip")
        self.pathline_database = QtWidgets.QLineEdit()

        # import hardwareRegs
        self.headline_Regs = QtWidgets.QLabel(
            "Select hardware register file (map.h) for import"
        )
        ...
        self.getMultiplefiles_Database_to_List.clicked.connect(
            self.get_multiple_files_database
        )
    ...
    def click_on_import_userdefined_csv(self):
        ...
        Controller.import_userdefined_csv(
            self,
            importPath,
            import_functions,
            import_objects,
