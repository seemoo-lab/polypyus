...
class GuiFromWindow(ida_kernwin.PluginForm):
    ...
    def create_gui(self):
        ...
        self.headline_elf = QtWidgets.QLabel("Select ELF, Polypyus CSV, or import user-defined file.")
        ...
        self.userdefined_csv_btn_elf = QtWidgets.QPushButton("Import user-defined CSV file")
        ...
        self.adjust_for_arm_thumb_checkbox =  QtWidgets.QCheckBox("Adjust for ARM Thumb mode (even vs. odd function starts).")
        ...
        #import hardwareRegs
        self.headline_Regs = QtWidgets.QLabel("Select hardware register file (map.h) for import")
